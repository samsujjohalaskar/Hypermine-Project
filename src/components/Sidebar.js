...
const Sidebar = () => {
  return (
    <div className="absolute top-[2px] left-[0px] rounded-xl bg-gainsboro box-border w-[265px] h-[2867px] z-[1] text-left text-sm text-text3 font-body-2 border-[1px] border-solid border-stroke-2">
