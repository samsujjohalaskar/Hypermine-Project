...
const FrameComponent1 = () => {
  return (
    <div className="w-[1573px] flex flex-row items-start justify-start relative max-w-full text-left text-base text-text3 font-body-2">
      <div className="h-[269px] w-[269px] absolute !m-[0] right-[386px] bottom-[165px] [filter:blur(600px)] rounded-[50%] [background:linear-gradient(180deg,_#6d31ba,_rgba(185,_113,_61,_0))]" />
      <div className="flex-1 flex flex-col items-start justify-start gap-[29px] shrink-0 [debug_commit:1de1738] max-w-full z-[1]">
        <div className="self-stretch rounded-xl bg-gray-400 box-border flex flex-row items-center justify-start py-[19px] pr-[39px] pl-5 relative gap-[33px] max-w-full border-[0.5px] border-solid border-text2 mq925:gap-[16px] mq1350:flex-wrap">
          <img
          ...
          <div className="w-[719px] flex flex-col items-start justify-start gap-[20px] min-w-[719px] max-w-full mq925:min-w-full mq1350:flex-1">
            <div className="flex flex-col items-start justify-start gap-[10px]">
              <div className="flex flex-col items-start justify-start gap-[10px] text-text1">
                <div className="w-[209px] h-[18px] flex flex-row items-start justify-start">
                  <h2 className="m-0 self-stretch flex-1 relative text-inherit leading-[120%] font-medium font-inherit overflow-hidden text-ellipsis">
                    NFT AIRPOD
                  </h2>
                </div>
            ...
            <div className="self-stretch flex flex-row flex-wrap items-center justify-start py-0 pr-[18px] pl-0 box-border gap-[10px] min-h-[42px] text-3xs text-black">
              <div className="flex flex-row items-start justify-start py-0 px-0 gap-[10px] mq450:flex-wrap">
                <div className="rounded-4xl bg-antiquewhite flex flex-row items-center justify-center py-[0.5px] px-6 opacity-[0.9]">
        ...
        <FrameComponent2 untitled11="/untitled-1-1@2x.png" />
        <FrameComponent2
          untitled11="/image-136@2x.png"
